...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	КлючеваяОперация = ОценкаПроизводительностиПовтИсп.ПолучитьКлючевуюОперациюПоИмени("Документ.РасходТовара");
...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	Если ТипЗнч(ДанныеЗаполнения) = Тип("ДокументСсылка.ЗаказыТоваров") Тогда
		...
		ВидКартЛояльности = ДанныеЗаполнения.ВидКартЛояльности;
		ОбоснованиеОтгрузки = Строка(ДанныеЗаполнения);
